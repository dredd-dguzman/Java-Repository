...
public class LabActivity5QuizAppAWT extends Frame implements ActionListener {
    ...
    String[][] options = {
        {"Central Process Unit", "Central Processing Unit", "Computer Power Unit", "Control Processing Utility"},
        {"Stack", "Queue", "Array", "Tree"},
        {"To play games", "To manage computer hardware and software", "To write documents", "To store files only"}
    };

    // Array of correct answers
    String[] answers = {"Central Processing Unit", "Queue", "To manage computer hardware and software"};
